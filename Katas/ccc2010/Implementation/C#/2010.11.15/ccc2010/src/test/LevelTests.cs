...
namespace ccc2010.src.test
{
    ...
    public class LevelTests
    {
        ...
        [Test]
        public void TestLevel7Acceptance()
        {
            PrintSequence(new Field(5, 4, 1, 1, 'O', 'S', 3).GetSequence());
            PrintSequence(new Field(5, 4, 3, 1, 'O', 'Z', 3).GetSequence());
            PrintSequence(new Field(10, 10, 10, 10, 'W', 'S', 1).GetSequence());
            PrintSequence(new Field(10, 10, 10, 10, 'W', 'S', 3).GetSequence());
            PrintSequence(new Field(17, 9, 17, 1, 'N', 'Z', 3).GetSequence());
            PrintSequence(new Field(97, 123, 1, 123, 'S', 'S', 3).GetSequence());
            PrintSequence(new Field(97, 123, 8, 123, 'W', 'Z', 8).GetSequence());
        }

        private static void PrintSequence(IEnumerable<int> sequence)
        {
